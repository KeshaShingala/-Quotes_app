  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: Icon(Icons.clear_all_outlined,color: Colors.black,size: 30,),
        title: const Text("Life Quotes and Sayings", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold),),
        actions: [
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      ...
                      image: (i == 0)
                          ...
                          : (i == 1)
                          ? const AssetImage("assets/images/2.jfif")
                          : (i == 2)
                          ? const AssetImage("assets/images/3.jpg")
                          : (i == 3)
                          ? const AssetImage("assets/images/4.jfif")
                          : (i == 4)
